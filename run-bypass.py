# Test script for bypass nodepay API's | By kucek Geming
import asyncio
import aiohttp
import time
import uuid
...
def show_warning():
    confirm = input("THIS IS BYPASSED VERSION - BYPASSED BY KUCEK GEMING (github/drilesmana) \n\nBy using this tool means you understand the risks. do it at your own risk! \nPress Enter BUAT LANJUT or Ctrl+C to cancel COK... ")
